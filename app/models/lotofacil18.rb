# encoding: UTF-8
class Lotofacil18 < ActiveRecord::Base
  attr_accessible :posicao, :a, :b, :c, :d, :e, :f, :g, :h, :i, :j, :k, :l, :m, :n, :o, :p, :q, :r, :pontos_15, 
...
self.per_page = 10
  ...
  def self.pesquisar(obj)
	...
	sql += ' and q in (' + obj.q.join(",") + ')'
	sql += ' and r in (' + obj.r.join(",") + ')'
